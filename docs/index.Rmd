...
### empezamos en
`r countdown::countdown(minutes = 10, seconds = 00, left = "34.5%")`
...
---
class: middle, inverse
# Conceptos básicos `r emo::ji(keyword = "pencil2")`
...
# Volvemos en
`r countdown::countdown(minutes = 7, seconds = 00, top = "35%", right = "30%")`
---
class: inverse, middle

# Cómo ayudar a nuestra audiencia a entender lo que queremos comunicar `r emo::ji(keyword = "computer")`
...
## La forma más simple de ir más allá de las opciones por defecto, es usar temas pre-hechos `r emo::ji("package")`
---
# Paquetes para temas
